...
const SinglePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
                <Button 
                  size="lg" 
                  className="bg-white text-primary hover:bg-gray-100 hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl z-10 relative text-sm md:text-base"
                ...
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-white text-white hover:bg-white hover:text-primary hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl z-10 relative text-sm md:text-base"
            ...
            <div className="text-center order-first lg:order-last">
              <div className="bg-orange-500 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg inline-block mb-4 md:mb-6 shadow-lg">
      ...
      <section className="medical-section py-8 md:py-16">
        <div className="medical-container px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <Card className="medical-card text-center hover:shadow-lg transition-all duration-300 hover:scale-105 transform">
              <CardContent className="pt-4 md:pt-6 px-3 md:px-6">
                <MessageCircle className="h-6 w-6 md:h-8 md:w-8 text-green-600 mx-auto mb-2 md:mb-3" />
                ...
                <Button size="sm" className="bg-green-600 hover:bg-green-700 hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl z-10 relative text-xs md:text-sm">
            ...
            <Card className="medical-card text-center hover:shadow-lg transition-all duration-300 hover:scale-105 transform">
              <CardContent className="pt-4 md:pt-6 px-3 md:px-6">
                <Clock className="h-6 w-6 md:h-8 md:w-8 text-primary mx-auto mb-2 md:mb-3" />
      ...
      {/* About Section */}
      <section id="about" className="bg-white medical-section py-8 md:py-16">
        <div className="medical-container px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                <div className="flex items-start space-x-3 text-left">
                  <Users className="h-5 w-5 md:h-6 md:w-6 text-primary mt-1 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start space-x-3 text-left">
                  <Heart className="h-5 w-5 md:h-6 md:w-6 text-primary mt-1 flex-shrink-0" />
                  <div>
            ...
            <div className="space-y-4 md:space-y-6">
              <Card className="medical-card hover:shadow-lg transition-all duration-300 hover:scale-105 transform">
                <CardContent className="p-4 md:p-6">
                  <Shield className="h-6 w-6 md:h-8 md:w-8 text-primary mb-2 md:mb-3" />
              ...
              <Card className="medical-card hover:shadow-lg transition-all duration-300 hover:scale-105 transform">
                <CardContent className="p-4 md:p-6">
                  <Star className="h-6 w-6 md:h-8 md:w-8 text-primary mb-2 md:mb-3" />
        ...
        <div className="medical-container px-4">
            ...
            {[
              ...
              <Card key={index} className="medical-card hover:shadow-lg transition-shadow">
                <CardContent className="pt-4 md:pt-6 p-4 md:p-6">
                  <service.icon className={`h-6 w-6 md:h-8 md:w-8 ${service.color} mb-3 md:mb-4`} />
          ...
          <div className="text-center">
            <Button 
              size="lg" 
              variant="outline"
              className="hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl z-10 relative border-2 hover:border-primary text-sm md:text-base"
              onClick={() => scrollToSection('appointment')}
            >
              {t('services.view_all')}
            </Button>
            ...
            {[
              ...
              <Card key={index} className="medical-card text-center">
                <CardContent className="pt-6 md:pt-8 p-4 md:p-6">
                  <feature.icon className="h-8 w-8 md:h-10 md:w-10 lg:h-12 lg:w-12 text-primary mx-auto mb-3 md:mb-4" />
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-white medical-section py-8 md:py-16">
        <div className="medical-container px-4">
          <div className="text-center mb-8 md:mb-12">
      ...
      {/* Appointment Section */}
      <section id="appointment" className="medical-section py-8 md:py-16">
        <div className="medical-container px-4">
          <div className="text-center mb-8 md:mb-12">
